<?php
    ...
    */
	...
	$subject_hint = __("Enter the subject of the email that is sent to the bidders to remind that the auction is ending soon. Available template tags:-\\n
	...
	$body_hint =__("Enter the email that is sent to the bidders to remind that the auction is ending soon. HTML is accepted. Available template tags:-\\n
...
<form id="uat-email-setting-form" class="uat-<?php echo $email_slug;?>-email-setting-form" method="post" action="">
   <h3><?php _e("Ending Soon ", "ultimate-auction-pro-software");?></h3>
