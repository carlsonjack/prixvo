<?php
    ...
    */
	...
	$subject_hint = __("Enter the subject of the email that is sent to the user once their registration has been approved. Available template tags:-\\n
					{site_title} - The name of the blog\\n
					{username} - Name of user\\n
               {first_name} - First Name of user", 'ultimate-auction-pro-software');

	$body_hint =__("Enter the email that is sent to the user once their registration has been approved. HTML is accepted. Available template tags:-\\n
					{username} - Name of user\\n
               {first_name} - First Name of user", 'ultimate-auction-pro-software');
...
<form id="uat-email-setting-form" class="uat-<?php echo $email_slug;?>-email-setting-form" method="post" action="">
   <h3><?php _e("Registration Approved for User", "ultimate-auction-pro-software");?></h3>
