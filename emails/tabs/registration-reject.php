<?php
    ...
    */
	...
	$subject_hint = __("Enter the subject of the email that is sent to the user when their registration has been rejected. Available template tags:-\\n
					  {site_title} - The name of the blog\\n
					  {username} - Name of user\\n
                 {first_name} - First Name of user", 'ultimate-auction-pro-software');

	$body_hint =__("Enter the email that is sent to the user when their registration has been rejected. HTML is accepted. Available template tags:-\\n
					{site_title} - The name of the blog\\n
					{username} - Name of user\\n
               {first_name} - First Name of user", 'ultimate-auction-pro-software');
...
<form id="uat-email-setting-form" class="uat-<?php echo $email_slug;?>-email-setting-form" method="post" action="">
   <h3><?php _e("Registration Reject", "ultimate-auction-pro-software");?></h3>
