<?php
    ...
    */
	...
	$subject_hint = __("Enter the subject of the email that is sent to the seller once their product is Adjustment Needed. Available template tags:-\\n
									{site_title} - The name of the blog\\n
									{product_name} - Auction item name\\n
									", 'ultimate-auction-pro-software');

	$body_hint =__("Enter the email that is sent to the seller once their product is Adjustment Needed. Available template tags:-\\n
