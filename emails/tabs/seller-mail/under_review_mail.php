<?php
    ...
    */
	...
	$subject_hint = __("Enter the subject of the email that is sent to the seller once their product is Under Review. Available template tags:-\\n
									{site_title} - The name of the blog\\n
									{product_name} - Auction item name\\n
									", 'ultimate-auction-pro-software');

	$body_hint =__("Enter the email that is sent to the seller once their product is Under Review. Available template tags:-\\n
	...
	// $email_tabs = apply_filters('ua_add_email_templates_tabs', ultimate_auction_pro_seller_emails_tabs());
	$newArray = array();
	$label = "";
