...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
		...
		<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" disabled name="user" id="user" value="<?php echo esc_attr( $user->user_login ); ?>" /> <span><em><?php esc_html_e( 'Your username is a unique identifier and cannot be changed. It represents your identity on our platform and is used for logging in and interacting with others.', 'woocommerce' ); ?></em></span>
	</p>
	<div class="clear"></div>
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
