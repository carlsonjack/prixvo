...
<div class="timer-closes-text">
    ...
    <div class="bid-inf-box">
                    ...
                    <?php if ($field_options_to_place_bid == "show-text-field-and-quick-bid") { ?>
                        ...
                        if ($hide_quick_bid == "off") {  ?>
                            ...
                            <div class="two-attr-block">
                                ...
                                <?php if (is_user_logged_in()) { ?>
									<button class="black_bg_btn bid_directly_btn"><?php echo apply_filters('uat_detail_page_direct_bid_button_text', __('Place Bid', 'ultimate-auction-pro-software')); ?></button>
								<?php }else{ ?>
									<a  data-fancybox="" style="width: 200px;display: inline-block;margin: 0;margin-left: 10px;" data-src="#uat-login-form" href="javascript:;" class="black_bg_btn contact-seller"><?php echo apply_filters('uat_detail_page_direct_bid_button_text', __('Place Bid', 'ultimate-auction-pro-software')); ?></a>
								<?php } ?>
                            </div>

                        <?php } ?>
                        <div class="bid-price-l">
                            <h5 style="margin-bottom: 0;"><strong><?php echo apply_filters('uat_detail_page_max_bid_button_text', __('Maximum Bid', 'ultimate-auction-pro-software')); ?></strong>
                        </div>
                        <div class="two-attr-block">
                            <input type="number" class="max_bid_directly_input" name="max_bid_directly_input" data-max-bid="0" data-is-max="0">
                            <span><?php echo get_woocommerce_currency_symbol(); ?></span>
                            <?php if (is_user_logged_in()) { ?>
							<button class="black_bg_btn max_bid_directly_btn"><?php echo apply_filters('uat_detail_page_max_bid_button_text', __('Maximum Bid', 'ultimate-auction-pro-software')); ?></button>
							<?php }else{  ?>
								<a  data-fancybox="" style="width: 200px;padding: 10px 16px;display: inline-block;margin: 0;margin-left: 10px;" data-src="#uat-login-form" href="javascript:;" class="black_bg_btn contact-seller"><?php echo apply_filters('uat_detail_page_direct_bid_button_text', __('Maximum Bid', 'ultimate-auction-pro-software')); ?></a>
							<?php } ?>
                        </div>
                        <div class="error-msg-box" id="bid_msg"></div>
                    <?php  } ?>
        ...
        <?php endif; ?>
		<div class="faq-link">
			<svg fill="#000000" width="20px" height="20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="margin-right: 6px;position: relative;top: 3px;"><g id="SVGRepo_iconCarrier"><path d="M12,22A10,10,0,1,0,2,12,10,10,0,0,0,12,22Zm0-2a1.5,1.5,0,1,1,1.5-1.5A1.5,1.5,0,0,1,12,20ZM8,8.994a3.907,3.907,0,0,1,2.319-3.645,4.061,4.061,0,0,1,3.889.316,4,4,0,0,1,.294,6.456,3.972,3.972,0,0,0-1.411,2.114,1,1,0,0,1-1.944-.47,5.908,5.908,0,0,1,2.1-3.2,2,2,0,0,0-.146-3.23,2.06,2.06,0,0,0-2.006-.14,1.937,1.937,0,0,0-1.1,1.8A1,1,0,0,1,8,9Z"></path></g></svg>
			<a href="<?php echo home_url(); ?>/faq" target="_blank">Learn how buying works</a>
		</div>
        <?php
        ...
        jQuery("document").ready(function($) {
            ...
            jQuery(document).on('click', ".max_bid_directly_btn", function(event) {
                ...
                if (!uwa_bid_value) {
                    ...
                    <?php
                    $bidvallue_msg = "<div class='msgbox-title msgbox-title-red' id='outbidMsg'>" . __("Invalid bid amount", 'ultimate-auction-pro-software') . "</div><div class='msgbox-text'>" . __("Please enter max bid amount", 'ultimate-auction-pro-software') . "</div>";
                    ?>
                    document.querySelector('#uat-msgbox-message').innerHTML = "<?php echo uat_bid_message_in_popup($bidvallue_msg); ?>";
                    document.querySelector('.msgbox').click();
                    return false;
