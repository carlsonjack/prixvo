        ...
        <div class="Current-bid-detail" data-product_id="<?php echo esc_attr($product_id); ?>">
            <h5>
                ...
                <small>(<?php echo '<span class="auction-bid-count">' . $bid_count . '</span>'; ?>
                    <?php _e("Bids", "ultimate-auction-pro-software") ?>,
                    <?php echo '<span class="auction-reserve-price-text">' . $uwa_reserve_txt . '</span>'; ?>)</small>
                <?php } else { ?>
                <small>(<?php echo '<span class="auction-bid-count">' . $bid_count . '</span>'; ?>
                    <?php _e("Bid", "ultimate-auction-pro-software") ?>,
                    <?php echo '<span class="auction-reserve-price-text">' . $uwa_reserve_txt . '</span>'; ?>)</small>
                <?php } ?>
            </h5>
            <h5>
                <div class="json_current_bid" data-userid="<?php echo esc_attr($product_id); ?>"
                    data-starting="<?php echo $product->get_uwa_auction_start_price(); ?>">
        ...
        <div class="bid-price-selection place-bid-sec">
            <div class="bid-price-l">
                ...
                <div class="pricel-l-right" style="display: flex;align-items: center;">
                    ...
                    <h5 style="padding-left: 2px;margin-bottom: 0;">
                        <strong><?php _e('SECURE', 'ultimate-auction-pro-software'); ?></strong></h5>
                </div>
            </div>
            <?php
            ...
            <form id="uat_auction_form" class="uat_auction_form cart" method="post" enctype='multipart/form-data'
                ...
                <?php
                    ...
                    ?>
                <div id="reactsel" data-total-bids="<?php echo $no_of_next_bids; ?>"
                    data-inc-enable="<?php echo $uat_variable_inc_enable; ?>"
                    data-current-bid="<?php echo $curent_bid; ?>"
                    data-price-range="<?php echo htmlspecialchars(json_encode($narr)); ?>"
                    data-bid-increment="<?php echo $bid_increment; ?>" data-userid="<?php echo $product_id; ?>">
                </div>
